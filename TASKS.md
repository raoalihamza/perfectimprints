...
- [x] Footer static pages built on the `page` builder from PI's own content, footer-linked, in sitemap; Contact has the lead form; Terms seeded as a draft (not fabricated)
