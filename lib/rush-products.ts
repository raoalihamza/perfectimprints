...
import type { RushProductsFacetSection, RushProductsFacetValue } from './rush-products-filter';
 ...
 */
export function applyHiddenSkus(data: RushProductsData, hiddenSkus: string[]): RushProductsData {
